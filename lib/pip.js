...
function generateRequirementsFile(
  ...
  console.log('generateRequirementsFile', requirementsPath, targetFile)
...
function requirementsFileExists(servicePath, options, fileName) {
  console.log('requirementsFileExists', servicePath, fileName);
...
async function installRequirementsIfNeeded(
  ...
  console.log("installRequirementsIfNeeded", fileName);
  ...
  if (!requirementsFileExists(servicePath, options, fileName)) {
    console.log('Requirements file doesnt exist!');
    return false;
  }
...
async function installAllRequirements() {
  ...
  if (this.serverless.service.package.individually) {
    console.log('Doing it individually!')
    let doneModules = [];
