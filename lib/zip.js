...
function addVendorHelper() {
  if (this.options.dockerBuildPoetryMonorepo) {
    this.serverless.cli.log(
      'WARNING: Custom argument `zip` is untested with `dockerBuildPoetryMonorepo` and may not work correctly. Please check the output zip file to be certain that it works!'
    )
  }
